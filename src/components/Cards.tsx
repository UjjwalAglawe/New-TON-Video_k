  ...
  return (
    <div className='card-div'>
      <div className='card-inner p-2 '>
        {data ? (
          <div className='transition-transform transform hover:scale-105 hover:shadow-2xl'>
            ...
            <div className='flex flex-col justify-center items-center '>
              ...
              <div className='flex text-white justify-between items-center mb-3 gap-4 mt-3'>
                ...
                <button onClick={()=>{openNFT(data)}} id='ton-connect-btn'  type="button" className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded text-sm px-5 py-1.5 text-center me-2 ">Play</button>
